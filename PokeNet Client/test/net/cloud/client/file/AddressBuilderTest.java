...
public class AddressBuilderTest {
	...
	public void testBuilder() {
		...
		String result = FileAddressBuilder.newBuilder().space(PATH).filename(FILE).extension(EXT).createAddress().getPathString();
	...
	public void testBuilderNoException() {
		...
		String result = FileAddressBuilder.newBuilder().space(PATH).extension(EXT).createAddress().getPathString();
