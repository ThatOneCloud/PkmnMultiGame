 ...
 */
public abstract class PriorityContainer extends AbstractElement implements Container<Element> {
	 ...
	 */
	public PriorityContainer(int priority, int x, int y) 
	{
	 ...
	 */
	public PriorityContainer(int priority, int x, int y, int width, int height) 
	{
	...
	public void add(Element newChild)
	{
		...
		newChild.setParent(new ParentElement(this, this::add, this::remove));
	}
