...
public class QuasiRoot extends Interface {
	...
	/**
	 * Create a new root interface to the graphic element hierarchy. 
	 * This is meant to serve as a bridge between some other graphic library. 
	 * The position will be 0,0 as this is the root - there's really no other option. 
	 ...
	 * key is essentially a global hotkey of some sort. Since this is sort of the final 
	 * element any event should get to.
	...
	public void keyTyped(char key) {
		...
		// No interest in the key. We'll still let it travel up the class hierarchy.
		super.keyTyped(key);
	}
	
	/**
	 * Will show the stat overlay if it isn't already, otherwise it will close it. 
	 */
	private void toggleStatOverlay()
	{
		...
		if(statOverlay == null)
		{
			...
			statOverlay = InterfaceFactory.createStatOverlay(getWidth(), getHeight());
